...
)
{
  const int8_t* a0 = a;
  int8_t* c0 = c;
  float scale = qp_weights.scale * qp_input.scale / qp_output.scale;
  // float scale = qp_output.scale;
  const int32_t output_min_less_zero_point = 0;
  const int32_t output_max_less_zero_point = 127 - qp_output.zero_point;
  const int32_t output_zero_point = qp_output.zero_point;
  ...
  do {
    ...
    vfacc1 = __riscv_vfmul_vf_f32m4(vfacc1, scale, vl);
    ...
    vfacc2 = __riscv_vfmul_vf_f32m4(vfacc2, scale, vl);
    ...
    vfacc3 = __riscv_vfmul_vf_f32m4(vfacc3, scale, vl);
    ...
    vfacc4 = __riscv_vfmul_vf_f32m4(vfacc4, scale, vl);
    ...
    vfacc5 = __riscv_vfmul_vf_f32m4(vfacc5, scale, vl);
    ...
    vfacc6 = __riscv_vfmul_vf_f32m4(vfacc6, scale, vl);
