...
void int8_vec_conv2_5x5(size_t rows, size_t cols, size_t a_stride, size_t b_stride,
...
void dwconv_5x5_int8_VCO(
    ...
    for (size_t ch = 0; ch < channels; ch++) {
        ...
        int8_vec_conv2_5x5(rows, cols, a_stride, b_stride, k_ch, a_ch, b_ch, ((const int32_t*) weights)[ch], requant_params.zero_point, requant_params.scale[ch]);
    }
}